...
```
Created → Locked → Proof generated → Settled
```
...
- Hedera Testnet: [https://hashscan.io/testnet](https://hashscan.io/testnet)
...
<Steps>
  <Step title="Wait for the deposit to confirm">
    Check the source-chain block explorer to confirm your deposit transaction has been included in a block. Sepolia typically takes 15–60 seconds; Hedera and Stellar may vary.
  </Step>
