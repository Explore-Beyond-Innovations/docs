...
Open [ProofBridge](https://app.pfbridge.xyz), connect your wallet, and navigate to **My Orders**. The page lists all orders associated with your address, with the most recent at the top. Click any order to open its detail view.
