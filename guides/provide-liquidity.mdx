...
<Note>
  ...
  - **Liquidity** — fund the ad with bridgeable tokens (ERC-20 / SAC / SEP-41). Claim them from the in-app [Faucet](https://app.pfbridge.xyz/faucet) if you don't already hold any.
</Note>
...
- Testnet tokens to fund the ad — claim them from the in-app [Faucet](https://app.pfbridge.xyz/faucet) if needed.

## Create a liquidity ad

<Steps>
  <Step title="Connect your wallet on the destination chain">
    Open [ProofBridge](https://app.pfbridge.xyz) and connect your wallet to the chain where you hold the tokens you want to provide. For example, if you want to offer XLM to Bridgers coming from Ethereum Sepolia, connect your Stellar wallet.
  </Step>
