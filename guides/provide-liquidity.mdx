...
<Note>
  ProofBridge is live on testnet. All funds involved are testnet tokens with no real-world value. Get Sepolia ETH from the [Sepolia faucet](https://sepoliafaucet.com) and HBAR from the [Hedera portal](https://portal.hedera.com).
</Note>
