...
<Warning>
  This is the **blueprint** for Phase 5, not final source. Tokenomics,
  staking parameters, slashing penalties, and chain-expansion timing
  are all subject to ecosystem signal and the first ~3 months of
  mainnet operational data. The shape (DAO over arbiter, stake-and-slash
  for agents, scoped per-tranche expansions) is the working plan.
</Warning>
...
<img src="/reference/architecture/_diagrams/phase-5-followups.png" alt="Phase 5 architecture — DAO governance and agent slashing" />

## Delta from Phase 4

What changes vs [Phase 4](/reference/architecture/phase-4-mainnet):
