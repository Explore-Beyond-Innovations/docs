...
<ParamField query="chainId" type="string">
  Filter by the numeric chain ID as a string (e.g., `"296"` for Hedera Testnet, `"11155111"` for Ethereum Sepolia).
</ParamField>
  ...
  "data": [
    {
      ...
      "chainId": "296",
      "kind": "EVM",
      "adManagerAddress": "0xA1B2C3D4E5F60718293A4B5C6D7E8F9012345678",
      "orderPortalAddress": "0xB2C3D4E5F60718293A4B5C6D7E8F9012345678AB",
...
<ParamField path="chainId" type="string" required>
  The numeric chain ID of the network to retrieve (e.g., `"296"` or `"11155111"`). Do not use the internal UUID — use the public chain ID.
</ParamField>
...
<ResponseField name="name" type="string" required>
  Human-readable name of the network (e.g., `"Hedera Testnet"`, `"Ethereum Sepolia"`).
</ResponseField>
