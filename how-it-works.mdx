...
<Steps>
  ...
  <Step title="Relayer runs the deposit proof circuit">
    ...
    The proof is a succinct attestation that those conditions hold against the source chain's MMR root, so the destination chain can verify it without reading the source chain directly.
  </Step>
