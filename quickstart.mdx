...
- **Testnet funds.** You need either Sepolia ETH or Hedera Testnet HBAR to cover the deposit and gas. Get Sepolia ETH from a public faucet, or Hedera Testnet HBAR from the [Hedera Developer Portal](https://portal.hedera.com/).
...
<AccordionGroup>
  <Accordion title="How long does a transfer take?">
    Most transfers complete within a few minutes. The main variable is block confirmation time on the source chain. Sepolia confirmations typically take under a minute; Hedera is faster. Proof generation adds a small amount of additional time.
  </Accordion>
